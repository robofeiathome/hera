...
class Goto(AbstractAction):
    ...
    def __init__(self, robot):
        super(Goto, self).__init__(robot)
        self.robot_ns = rospy.get_namespace()

        self._as = actionlib.SimpleActionServer("goto", gotoAction, self.goal_callback, False)
        self._as.start()
    ...
    def goal_callback(self, goal):
        ...
        self._as.set_succeeded(gotoResult(result=result))

    def execute(self, location):
        self.robot.add_log('Goto', location, color=LogColor.YELLOW)
